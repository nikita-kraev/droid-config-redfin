# DisplayName: Jolla redfin/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: redfin
# DeviceVariant: redfin
# Brand: Jolla
...
repo --name=adaptation-common-redfin-@RELEASE@ --baseurl=https://releases.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-common/@ARCH@/
repo --name=adaptation-community-common-redfin-@RELEASE@ --baseurl=https://repo.sailfishos.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
patterns-sailfish-device-configuration-redfin
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/redfin
